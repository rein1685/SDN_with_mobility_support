...
class VendorEvent : public ControllerEvent {
public:
    VendorEvent(OFConnection* ofconn, OFHandler* ofhandler, void* data, size_t len) :
    ControllerEvent(ofconn, EVENT_VENDOR) {
        this->data = (uint8_t*) data;
        this->len = len;
        this->ofhandler = ofhandler;
    }
...
public:
	...
	else if(type == 4) { // OFTP_VENDOR
	    dispatch_event(new VendorEvent(ofconn , this , data , len));
	}
    }
